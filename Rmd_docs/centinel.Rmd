---
title: "Covid Centinel"
author: "Michael Roswell, Jonathan Dushoff"
date: "3/7/2022"
...
nel_vid<-new_vid %>% mutate(nel_rate = Ln(cases_avg_per_100k/ref_case_rate)
...
I struggled some with programming good breaks and labels for the ratio scale.
Suggestions/improvements welcomed! [Jonathan](https://twitter.com/jd_mathbio)
and I are also interested in comments on "centinels!"

Thanks!

### Draft ratio scale code
